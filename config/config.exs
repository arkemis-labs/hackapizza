...
config :hackapizza, HackapizzaWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: HackapizzaWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Hackapizza.PubSub,
  live_view: [signing_salt: "oSvlRuv+"]
...
config :arke_server,:mailer_module, Hackapizza.Mailer

# The endpoint module define which servers show in the swagger. You can pass a single one or a list
config :arke_server, endpoint_module: HackapizzaWeb.Endpoint
config :logger,
        backends: [:console],
