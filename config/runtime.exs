    ...
    topologies: [
      erlang_nodes_in_k8s: [
        ...
        config: [
          ...
          application_name: System.get_env("RELEASE_NAME", "hackapizza"),
          polling_interval: 10_000
        ]
      ]
    ]

  config :hackapizza, HackapizzaWeb.Endpoint, server: true
...
#
#     config :hackapizza, Hackapizza.Mailer,
#
...
config :hackapizza, Hackapizza.Mailer, adapter: Swoosh.Adapters.Local
